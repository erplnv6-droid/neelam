...
public class GetEinvoice {
	...
	public GetEinvoice(long id, @NotNull long ackNo, @NotNull String ackDt, @NotNull String irn,
			@NotNull String signedInvoice, @NotNull String signedQRCode, @NotNull String status, @NotNull long ewbNo,
			@NotNull String ewbDt, @NotNull String ewbValidTill, @NotNull String decodedInvoice,
			@NotNull String decodedQrCode, @NotNull int sales_id) {
		super();
		this.id = id;
		AckNo = ackNo;
		AckDt = ackDt;
