...
public class PrintSetBarcodeDto {
...
private long id;
	...
	public PrintSetBarcodeDto(long id, Brand brand, Product product, int noprint, LocalDate createddate,
