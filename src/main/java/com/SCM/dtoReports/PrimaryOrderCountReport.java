...
public class PrimaryOrderCountReport {
private int total_pending_count;
	...
	public PrimaryOrderCountReport(int total_pending_count, int total_converted_count, int total_count,
			int total_amount) {
		super();
	...
	public PrimaryOrderCountReport() {
		super();
