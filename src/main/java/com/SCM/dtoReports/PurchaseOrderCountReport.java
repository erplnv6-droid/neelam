...
public class PurchaseOrderCountReport {
...
private int total_pending_count;
	...
	public PurchaseOrderCountReport(int total_pending_count, int total_converted_count, int total_count,
			double total_amount) {
		super();
	...
	public PurchaseOrderCountReport() {
		super();
