...
public class WorkOrderCountReport {
	...
	public WorkOrderCountReport(int total_pending_count, int total_converted_count, int total_count, int total_amount) {
		super();
