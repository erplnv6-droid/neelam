...
public interface Group4Repository extends JpaRepository<Group4, Long>{
	...
	@Query(value = "select id as id,title,DATE_FORMAT(createddate,'%d-%m-%Y') as createddate,createdtime,DATE_FORMAT(updateddate,'%d-%m-%Y') as updateddate,updatedtime,createbyname,updatedbyname "
			+ " from group4\r\n",nativeQuery = true)
	List<IndexGroup4> indexGroup4();
	
	@Query(value = "select id as id,title,DATE_FORMAT(createddate,'%d-%m-%Y') as createddate,createdtime,DATE_FORMAT(updateddate,'%d-%m-%Y') as updateddate,updatedtime,createbyname,updatedbyname "
			+ " from group4\r\n",nativeQuery = true)
	List<IndexGroup4> indexGroup4(Pageable p);
	...
	@Query(value =  "select id as id,title,DATE_FORMAT(createddate,'%d-%m-%Y') as createddate,createdtime,DATE_FORMAT(updateddate,'%d-%m-%Y') as updateddate,updatedtime,createbyname,updatedbyname "
			...
			,nativeQuery = true)
	List<IndexGroup4> indexGroup4(String search,Pageable p);
